...
import { apiConstructorFetch, CONSTRUCTOR_URL } from "~/composables/Exports";
    ...
    <div class="components-header">
      <ul class="components-header-list">
        <li class="components-header-item">
          <button class="components-header-button">Каталог секции</button>
        </li>
      </ul>
    </div>
      ...
      <aside class="components-aside">
        <ul class="components-list">
          <li
            ...
            :style="{
              display:
                item.id === 'defaults' || item.length == 0 ? 'none' : 'block',
              color: 'black',
            }"
